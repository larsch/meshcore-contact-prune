...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--whitelist", type=str, default=None, help="Contact names to always keep, e.g. 'Alice,Bob'")
    ...
    p.add_argument("--no-backup", action="store_true", default=False, help="Skip exporting before delete, faster but no recovery")
    ...
    p.add_argument("-s", "--serial", type=str, default=None, help="Serial port path, e.g. /dev/ttyACM0")
